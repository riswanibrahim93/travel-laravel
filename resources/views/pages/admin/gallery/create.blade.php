		        ...
		        <div class="col-lg-6">
		            <div class="card mt-2 mx-auto p-4 bg-light">
		                <div class="card-body bg-light">
		                    <div class="container">
		                        <form id="contact-form" role="form" action="{{ route('gallery.store') }}" method="post" enctype="multipart/form-data">
		                        	@csrf
		                            <div class="controls">
		                                <div class="row">
		                                    <div class="col-md-12">
		                                        <div class="form-group"> <label for="form_need">Travel Package</label> 
		                                        	<select id="form_need" name="travel_packages_id" class="form-control" required="required" data-error="Please specify your need.">
